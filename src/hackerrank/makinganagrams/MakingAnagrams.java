 ...
 * 
 * Remove d and e from cde to get c. Remove a and b from abc to get c. We must
 * delete characters to make both strings anagrams, so we print on a new line.
 * 
 * @author dwaraknathbs
 *
 */
public class MakingAnagrams {
	...
	public static int numberNeeded(String first, String second) {
		...
		/**
		 * Keep a frequency count of each of the characters
		 */
		...
		/**
		 * Subtract the char count when seeing the same char in the next string
		 */
		...
		/**
		 * Sweep the alphabet array and add the characters count which have
		 * non-zero val
		 */
		int count = 0;
		for (int i = 0; i < 26; i++) {
