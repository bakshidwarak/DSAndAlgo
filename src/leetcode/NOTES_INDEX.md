# LeetCode Problems 61-80: Complete Notes Index
...
#### Easy Problems (9)
1. Longest Uncommon Subsequence I (521)
2. Maximize Distance to Closest Person (849)
3. Meeting Rooms I (252)
4. Merge Sorted Array (88)
5. Merge Two Binary Trees (617)
6. Merge Two Sorted Lists (21)
7. Min Cost Climbing Stairs (746)
8. Minimum Moves to Equal Array Elements (453)
9. Find Mode in Binary Search Tree (501)

#### Medium Problems (6)
1. Lowest Common Ancestor of a Binary Search Tree (235)
2. Majority Element II (229)
3. Merge Intervals (56)
4. Minimum Genetic Mutation (433)
5. Minimum Path Sum (64)
6. Merge Intervals (56)

#### Hard Problems (4)
1. Longest Substring with At Most Two Distinct Characters (159)
2. Maximal Rectangle (85)
3. Find Median from Data Stream (295)
4. Merge K Sorted Linked Lists (23)
5. Minimum Cost to Hire K Workers (857)
...
1. **Find the problem** you want to study using the indexes above
2. **Open the notes.md file** from the corresponding directory
3. **Read through sections** in this recommended order:
   - Problem Statement
   - Examples
   - Key Insights
   - Algorithm Steps
...
All notes files follow this pattern:
```
/tmp/DSAndAlgo/src/leetcode/{problem-directory}/notes.md
```

Example:
```
/tmp/DSAndAlgo/src/leetcode/medianfinder/notes.md
/tmp/DSAndAlgo/src/leetcode/mergeintervals/notes.md
/tmp/DSAndAlgo/src/leetcode/minpathsum/notes.md
```
